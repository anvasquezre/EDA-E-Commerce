...
DATASET_ZIP_PATH = str(Path(__file__).parent.parent / "dataset" / "dataset_ecommerce.zip")
...
DATA_URL = "https://drive.google.com/uc?export=download&id=10UWjHfoGhnYiYFLNEvROmI-U0MEFub6x"
